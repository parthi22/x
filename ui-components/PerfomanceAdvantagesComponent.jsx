...
export default function PerfomanceAdvantagesComponent(props) {
    ...
    >
      ...
      >
        <Text
          ...
          position="relative"
          padding="0px 0px 0px 0px"
          children="Performance management as easy as play dough"
      ...
      >
        ...
        <Heading
          ...
          height="24px"
          level="6"
          children="Fully configurable reviews management"
      ...
      >
        ...
        <Heading
          ...
          height="24px"
          level="6"
          children="Solicit real-time 360˚ feedback for anyone"
      ...
      >
        ...
        <Heading
          ...
          height="24px"
          level="6"
          children="Gamify recognition processes with badges and rewards"
