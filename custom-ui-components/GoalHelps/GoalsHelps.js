...
export default function GoalsHelps() {
  ...
  let scrollBoxData = [
    {
      link: 'https://d2gxm2c63thfmv.cloudfront.net/wp-content/uploads/2021/06/21232309/10xgoals-screenshot-s1-v2-768x454.png',
      text: 'Run company-wide weekly OKR reviews using the User Board. Get a bird’s eye-view of all assigned OKRs, with detailed views into their average progress',
    },
    {
      link: 'https://d2gxm2c63thfmv.cloudfront.net/wp-content/uploads/2021/06/21232309/10xgoals-screenshot-s1-v2-768x454.png',
      text: 'Run company-wide weekly OKR reviews using the User Board. Get a bird’s eye-view of all assigned OKRs, with detailed views into their average progress',
