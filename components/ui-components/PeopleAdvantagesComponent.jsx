...
export default function PeopleAdvantagesComponent(props) {
    ...
    >
      ...
      >
        <Text
          ...
          fontSize="40px"
          fontWeight="700"
          color="rgba(36.00000165402889,43.00000123679638,116.00000068545341,1)"
          lineHeight="40px"
          textAlign="left"
          display="flex"
          direction="column"
          ...
          position="relative"
          padding="0px 0px 0px 0px"
          children="Bring Science to Employee Engagement"
      ...
      >
        ...
        <Heading
          ...
          height="24px"
          level="6"
          children="Measure and continuously improve your org health and culture via eNPS"
      ...
      >
        ...
        <Heading
          ...
          height="24px"
          level="6"
          children="Understand manager scores and drive targeted development"
      ...
      >
        ...
        <Heading
          ...
          height="24px"
          level="6"
          children="Focus on the right feedback, not all feedback"
