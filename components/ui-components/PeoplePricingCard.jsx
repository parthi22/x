...
export default function PeoplePricingCard(props) {
  ...
  return (
    ...
    >
      <Text
        ...
        children="Starting at just $2/user"
      ...
      >
        ...
        <Heading
          ...
          height="24px"
          level="6"
          children="Onboarding support by an experienced HR leader"
      ...
      >
        ...
        <Heading
          ...
          height="48px"
          level="6"
          children="Actionable insights and analytics for your business, people, and culture"
      ...
      >
        ...
        <Heading
          ...
          height="24px"
          level="6"
          children="Debrief of org insights with leadership"
      ...
      >
        ...
        <Heading
          ...
          height="24px"
          level="6"
          children="Demographic level insights and manager scorecards"
      ...
      >
        <Text
          ...
          {...getOverrideProps(overrides, "Flex.Flex[4].Text[0]")}
        ></Text>
      </Flex>
    </Flex>
  );
